...
cp -rf ../components/arduino/CMa* arduino-esp32
cp -rf ../components/arduino/idf* arduino-esp32
cp -rf ../components/arduino/Kco* arduino-esp32
cp -rf ../components/arduino/pac* arduino-esp32
